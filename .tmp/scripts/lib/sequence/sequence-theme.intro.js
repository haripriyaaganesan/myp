...
var codePane = {
  ...
  getWindowSize: function getWindowSize($el) {
  ...
  init: function init(viewCodeButtons) {
  ...
  toggle: function toggle($step, $codePane, $button) {
  ...
  // element is clicked
  show: function show($step, $codePane, $button) {
   ...
   */
  hide: function hide($step, animate, $codePane, $button) {
...
//# sourceMappingURL=sequence-theme.intro.js.map
